...
public class homework0110 {
	public static void main(String[] args) {
		...
		/*
		 * int x; int y; if(x>0 && y>0) { System.out.println("제1사분면"); } else if(x<0 &&
		 * y>0) { System.out.println("제2사분면"); }else if(x<0 && y<0) {
		 * System.out.println("제3사분면"); }else { System.out.println("제4사분면"); }
		 */

		// 문제2) 연도가 주어졌을 때 해당 년도가 윤년인지를 확인해서 출력하도록 하세요.
		// 윤년은 연도가 4의 배수이면서 100의 배수가 아닐 때 또는 400의 배수일때입니다. /4==0 && /100!=0 ||/400==0
		// 예를 들어, 2012년은 4의 배수이면서 100의 배수가 아니라서 윤년이며,
		// 1900년은 100의 배수이고 400의 배수는 아니기 때문에 윤년이 아닙니다.
		// HiNT : 이중 IF문 사용
		// 문제출처, 백준(https://www.acmicpc.net/) 2753번 문제
		/*
		 * int year; if(year/4==0 && year/100!=0) { if(year/400==0) }
		 */
